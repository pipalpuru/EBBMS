...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        if (UserInfo.count == 0) {
            ...
            def testAdmin = new UserInfo(username: 'admin1', password: 'admin1', name:'admin', email:'admin1@email.com').save(flush: true)
            def testUser = new UserInfo(username: 'user1', password: 'user1', name:'user1', email:'user1@email.com').save(flush: true)
